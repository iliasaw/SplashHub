...
Frame.Size = UDim2.new(0, 299, 0, 178)
...
AbPlusEsp.Text = "Aim + ESP"
AbPlusEsp.TextColor3 = Color3.new(0, 0, 0)
AbPlusEsp.TextSize = 14
AbPlusEsp.MouseButton1Down:connect(function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/iliasaw/SplashHub/main/data/Game%20Scripts/Arsenal/Scripts/ArsenalHitboxExtender.lua",true))()
end)
...
ControlText.Text = "Press E = AimBot"
...
AbPlusEsp.MouseButton1Down:connect(function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/iliasaw/SplashHub/main/data/Game%20Scripts/Arsenal/Scripts/AB%2BESP.lua",true))()
end)

HitBoxText.Name = "Owl Hub"
