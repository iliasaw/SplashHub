...
section1:addDropdown("Scripts", {"Arsenal", "JailBreak", "RoBeats", "Bubble Gum Simulator", "Polybattle", "SCP: Roleplay", "Project Lazarus", "Lumber Tycoon 2", "Mad Paintball 2"}, function(text)
